...
function [joint, joint_r, joint_E] = fnc_getJointConfiguration (model, modelJoint_typeName, modelSegment_typeName, inParam_PersonInfo, segmentID, customJointConfiguration)
...
if nargin < 6
    ...
    % Do nothing, custom joint configurations not yet implemented - Manish 26.10.2016
end