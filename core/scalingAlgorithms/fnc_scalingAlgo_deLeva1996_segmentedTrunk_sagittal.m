...
if isempty(inParam_PersonInfo.height)... 
    ...
    disp ('  Check that the scaling type you are trying to use (fnc_scalingAlgo_deLeva1996_segmentedTrunk_sagittal) has all the information needed in the anthropometry file');
