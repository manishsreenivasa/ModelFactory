...
if isempty(inParam_PersonInfo.height) || isempty(inParam_PersonInfo.weight)...
    ...
    disp ('  Check that the scaling type you are trying to use (fnc_scalingAlgo_deLeva1996_segmentedTrunk) has all the information needed in the anthropometry file');
